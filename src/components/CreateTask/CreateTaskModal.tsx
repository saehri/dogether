...
import { Target, CheckCircle2, Calendar, X } from 'lucide-react';
          ...
          <DialogContent className="max-w-md max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto pr-2 -mr-2">
              <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                      <CardContent className="p-4 text-center">
                        ...
                        <div className="text-sm font-medium text-gray-900 dark:text-gray-100">Task</div>
                        <div className="text-xs text-gray-500 dark:text-gray-400">One-time completion</div>
                      </CardContent>
                    </Card>
                    <Card
                      className={cn(
                    ...
                    >
                      <CardContent className="p-4 text-center">
                        ...
                        <div className="text-sm font-medium text-gray-900 dark:text-gray-100">Goal</div>
                        <div className="text-xs text-gray-500 dark:text-gray-400">Repeating activity</div>
                      </CardContent>
                    </Card>
                  </div>
                </div>
                ...
                {/* Title */}
                <div>
                  <Label htmlFor="title" className="text-sm font-medium text-gray-700 dark:text-gray-200 mb-2 block">
                    Title *
                  </Label>
                  <Input
                    id="title"
                    ...
                    className={cn(
                      "transition-colors",
                      title.trim() === '' && "border-red-300 focus:border-red-500 focus:ring-red-200 dark:border-red-400"
                    )}
                ...
                {/* Description */}
                <div>
                  <Label htmlFor="description" className="text-sm font-medium text-gray-700 dark:text-gray-200 mb-2 block">
                    Description
                  </Label>
                  <Textarea
                    id="description"
            ...
            <div className="flex-shrink-0 pt-4 border-t border-gray-200 dark:border-gray-700">
              <div className="flex space-x-3">
                ...
                >
                  {isSubmitting ? 'Creating...' : `Create ${taskType === 'task' ? 'Task' : 'Goal'}`}
                </Button>
              </div>
            </div>
          </DialogContent>
